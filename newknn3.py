...
def training(trainfile = '../data/train.csv',testfile = '../data/test.csv',subfile = 'submission.csv' ,
    ...
    for rec in te1:
        ...
        if user1 in user_habit_dict:
            for eachAct in user_habit_dict[user1]:
                ...
                score = qidian+shijian+jiejia+bike+0.005              #jvli+fangxiang
        ...
        if start1 in start_end_dict:
            ...
            for eachAct in start_end_dict[start1]:
                ...
                score += (1.3-abs(isHoliday1-eachAct['isHoliday']))*0.3
        ...
        #终点起点对
        if start1 in end_start_dict:
            resultqizhong={}
            for eachAct in end_start_dict[start1]:
                score = 0
                score += (1.3-abs(isHoliday1-eachAct['isHoliday']))*0.1
                if eachAct['geohashed_start_loc'] in endDict:
                    endDict[eachAct['geohashed_start_loc']] += score
                else:
                    endDict[eachAct['geohashed_start_loc']] = score
...
if __name__ =="__main__":
    training('E:/Python/mobicup/data/train.csv', 'E:/Python/mobicup/data/test.csv', 'submission.csv')
